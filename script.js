...
const tabs=document.getElementById('countryTabs'),obs=document.getElementById('countryObs'),comments=document.getElementById('comments'),ratios=document.getElementById('ratios'),cbg=document.getElementById('countryBg');
